...
class TestTransactionSearchPage(unittest.TestCase):
    ...
    def test_search_page_markup(self, load_mock, save_mock):
        ...
        self.assertIn('id="tx-search-muted-section"', html)
        self.assertIn('id="tx-search-muted-tbody"', html)
        self.assertIn('Excluded from totals', html)
    ...
    def test_assets_present(self):
        ...
        self.assertIn('search-tx-table--muted', STYLE)
        self.assertIn('search-tx-muted-badge', STYLE)
        self.assertIn('search-muted-section', STYLE)
        self.assertIn('/api/spending/transactions/search', SEARCH_JS)
        self.assertIn('tx-search-tbody', SEARCH_JS)
        self.assertIn('tx-search-muted-tbody', SEARCH_JS)
        self.assertIn('isMutedTx', SEARCH_JS)
